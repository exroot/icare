...
function PageContent(props) {
  return (
    <>
      <div tw="container mx-auto w-10/12 h-screen overflow-y-scroll">
        <SectionTitle title="Review single user Screen" />

        <ReviewCard />
      </div>

      <div tw="bg-white shadow-lg rounded-lg border p-4 my-8 h-64 w-4/12"></div>
    </>
  )
}
...
function ProfilePhoto(props) {
  return (
    <>
      <div tw="place-self-start">
        {/* <div tw="place-self-center"> */}
        <img
          tw="h-16 w-16 rounded-sm"
      ...
      <table tw="bg-white table-auto shadow mx-auto w-full rounded-xl mb-6">
        <thead>
          <tr tw="text-center border-b capitalize">
            ...
            <th tw="px-4 py-2">date</th>
            <th tw="px-4 py-2">amount</th>
    ...
    <>
      <div tw="flex flex-col">
        <div tw="flex flex-col py-4">
          <ProfilePhoto />
          <p tw="text-xl font-bold leading-tight">Erin Lindford</p>
          <p tw="leading-tight">@username</p>
        </div>
        <div tw="flex flex-col py-4">
          ...
          <div tw="flex flex-col py-4">
            <p tw="text-lg font-bold leading-tight text-gray-600">Meta</p>
            <p tw="text-sm leading-tight text-gray-600">item</p>
          </div>
          <div tw="flex flex-col py-4">
            <p tw="text-lg font-bold leading-tight text-gray-600">
              Placeholder
            </p>
            <p tw="text-sm leading-tight text-gray-600">item</p>
          </div>
          {/* <hr /> */}
          <div tw="flex flex-col">
            <p tw="text-lg font-bold leading-tight text-gray-600">category</p>

            <p tw="text-sm leading-tight text-gray-600">item</p>
          </div>
          <div tw="flex flex-col py-4">
            <p tw="text-lg font-bold leading-tight text-gray-600">tags</p>
          ...
          <div tw="flex flex-col py-4">
            ...
            <p tw="text-sm leading-tight text-gray-600 border p-4 rounded-lg shadow-sm">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
              eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut eu
              sem integer vitae justo eget magna fermentum. Nibh praesent
              tristique magna sit amet.
            </p>
          </div>
          <div tw="flex flex-col">
            <p tw="text-lg font-bold leading-tight text-gray-600">add note</p>

            <p tw="text-sm leading-tight text-gray-600">input</p>
          </div>
          <div tw="flex flex-col">
            <p tw="text-lg font-bold leading-tight text-gray-600">notes</p>
            <p tw="text-sm leading-tight text-gray-600">table</p>
          </div>
        </div>
      </div>
    </>
  ...
  return (
    <>
      ...
      <div tw="flex flex-row">
        <div tw="w-8/12 bg-white shadow-lg rounded-lg border p-4 my-8">
          <UserInfo />
        </div>
        <div tw="bg-white shadow-lg rounded-lg border p-4 my-8 h-64 w-4/12"></div>
      </div>
