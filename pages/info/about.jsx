        ...
        <div tw="container flex flex-col md:flex-row items-center justify-around">
          ...
          <div tw="max-w-md text-xl font-light">
            ...
            <div tw="flex flex-row">
              <BiCheck size={26} color="#006CFF" />
              <p tw="text-white">
                Animated video panels<span style={{ color: "#ff27e1" }}>*</span>
              </p>
            </div>
            <div tw="flex flex-row">
              <BiCheck size={26} color="#006CFF" />
      ...
      <section tw="text-white">
        <div tw="container px-5 py-24 mx-auto">
          <div tw="lg:w-2/3 flex flex-col sm:flex-row sm:items-center items-start mx-auto">
            {/* <div> */}
            <h1 tw="text-center sm:text-left flex-grow sm:pr-16 text-2xl font-medium text-5xl sm:text-5xl font-black uppercase">
...
function Intro() {
  return (
    <>
      ...
      <section tw="m-0 flex flex-col w-screen justify-center min-h-screen text-gray-100">
        <nav>
